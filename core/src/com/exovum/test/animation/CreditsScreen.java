...
public class CreditsScreen implements Screen {
    ...
    public CreditsScreen(final SpriteBatch batch, final Game game, final Screen prevScreen) {
        this.batch = batch;
        this.game = game;
        ...
        Label myCredits = new Label("Programming and Development\n" +
                "Caleb Stevenson\nclbstevenson@gmail.com", skin, "small-font");
       ...
       // exitButton.padTop(2f);
        ...
        exitButton.addListener(new ChangeListener() {
            public void changed(ChangeEvent event, Actor actor) {
                Gdx.app.log("AnimatorMenuScreen", "Exiting to main menu");
