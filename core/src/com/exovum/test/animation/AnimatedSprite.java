 ...
 *
 *  MODIFICATION FROM ORIGINAL WORK:
 *      Two slight modifications to the original work were made. On lines 121 and 135, the original
 *      class used "animation.frameDuration". However, this variable is private in the Animation
 *      class. To fix this for my project, I changed the two lines to "animation.getFrameDuration()".
 *  */
